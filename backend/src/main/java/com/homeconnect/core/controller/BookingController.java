...
public class BookingController {
        ...
        public ResponseEntity<ApiResponse<BookingResponse>> selectApplicant(
                ...
                BookingResponse response = bookingService.selectApplicant(jobId, request.getApplicationId(),
                                customerId);
        ...
        @Operation(summary = "[BE-Exec-03] Thợ check-out + ảnh hoàn thành (Tú)", description = "Thợ gửi URL ảnh sau khi làm xong. Status: IN_PROGRESS → PENDING_COMPLETION (chờ khách xác nhận). Nếu làm < 80% thời gian, job bị gắn cờ bất thường.")
        ...
        @Operation(summary = "[BE-Exec-03b] Khách xác nhận hoàn thành (Tú)", description = "Khách bấm 'Xác nhận & Đánh giá'. Status: PENDING_COMPLETION → COMPLETED. Nếu khách im lặng 24h, hệ thống tự động xác nhận.")
